"""Initial graph document schema

Revision ID: 44cb62231d59
Revises: 
Create Date: 2025-10-23 19:33:18.877419
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('model_type_id', sa.UUID(), nullable=False),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('from_model_type_id', sa.UUID(), nullable=False),
    sa.Column('to_model_type_id', sa.UUID(), nullable=False),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('model_id', sa.UUID(), nullable=False),
    sa.Column('trait_type_id', sa.UUID(), nullable=False),
    ...
    sa.Column('relation_attribute_definition_id', sa.UUID(), nullable=False),
    sa.Column('value_text', sa.Text(), nullable=True),
    sa.Column('value_number', sa.Integer(), nullable=True),
    sa.Column('value_time', sa.DateTime(), nullable=True),
    sa.Column('value_bool', sa.Boolean(), nullable=True),
